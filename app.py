...
st.markdown("<h3> Then enter the key terms you want to focus on <em>(Example: climate)</em></h3>")
st.write("As you can see here, we're looking for accounts similar to that of Greta Thunberg and the WWF. We're focusing on the climate and sustainability", unsafe_allow_html=True)
